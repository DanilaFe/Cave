...
public class RenderSystem extends IteratingSystem {
	...
	public void update(float deltaTime) {
		...
		// Create the buffer         Format           Scrreen width            Screen height
		mainBuffer = new FrameBuffer(Format.RGBA8888, bufferSizeW, bufferSizeH, false);
		// Begins drawing to buffer
		mainBuffer.begin();
		// Set clear color
		Gdx.gl.glClearColor(1F, 1F, 1F, 1);
		// Clear screen
		Gdx.gl.glClear(Gdx.gl.GL_COLOR_BUFFER_BIT);
		// Set the projection matrix generated by the camera
		textureBatch.setProjectionMatrix(CaveGame.instance.orthoCam.combined);
		// Being drawing
		textureBatch.begin();
		// This draws entities' sprites
		super.update(deltaTime);
		// Stop drawing
		textureBatch.end();
		// Stops drawing to buffer
		mainBuffer.end();
